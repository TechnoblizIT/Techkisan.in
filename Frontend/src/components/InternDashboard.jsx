      ...
      case "ticket":
        return (
          <div className="intern-ticket-dashboard">
            {/* Top Buttons */}
            <div className="intern-top-btns">
              <button
                className={`intern-add-btn ${
                  page === "add" ? "active-btn" : ""
                }`}
            ...
            {/* Add Ticket Form */}
            {page === "add" && (
              <div className="intern-add-form-container">
                <form className="intern-add-form">
                  <div className="intern-form-field">
                  ...
                  <div className="intern-form-field file-upload-intern">
                  ...
                  <div className="intern-button-container">
            ...
            {/* Filter Ticket Form */}
            {page === "filter" && (
              <div className="intern-filter-page">
                <h2>Filter By:-</h2>
                <form className="intern-filter-ticket-form">
                  <div className="intern-filter-form">
                    <div className="intern-filter-field">
                    ...
                    <div className="intern-filter-btn-container">
                      <button type="button" className="intern-apply-btn">
                        Apply
                      </button>
                      <button type="button" className="intern-create-btn">
                        Create
                      </button>
                    </div>
                  </div>
                      ...
                      <tbody>
                        {(activeTab === "open"
                          ...
                          <tr key={index}>
                            ...
                            <td>
                              <span className="intern-status-text">
                                {ticket.status}
                              </span>
                            </td>
                            <td className={`left-border color-${index % 5}`}>
                            ...
                            <td className="intern-action-icons">
                              <button className="intern-edit-btn">
                                <i className="fa-solid fa-pen-to-square"></i>
                              </button>
                              <button className="intern-delete-btn">
