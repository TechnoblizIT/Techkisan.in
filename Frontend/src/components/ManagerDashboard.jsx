                ...
                <tbody className="bg-white">
                  <tr className="border-b hover:bg-gray-100 transition-all duration-200">
                    ...
                    <td className="px-6 py-3 text-gray-600">
                      ...
                      Accusamus officiis totam, voluptates aliquam esse ut,
                      mollitia possimus ratione enim iure quos nihil dicta ipsa
                      ducimus fugiat nulla repudiandae sunt voluptatem sit?
                      Aliquam vitae earum maiores, sapiente, rem voluptate
                      alias, nisi odit fugit quia facere nam veniam porro
                      doloribus aliquid reiciendis!
                    </td>
...
=======
      ...
      <div className="manager-top-btns">
        <button className="manager-add-btn">+ Add</button>
        <button className="manager-filter-btn">Filter</button>
      </div>
      {/* Open & Close Buttons */}
      <div className="manager-openclose-btns"> 
  <button className="manager-status-btn" onClick={() => setActiveTab("open")}>
    <span className={`number-badge ${activeTab === "open" ? "blue-badge" : "grey-badge"}`}>2</span> Open
  </button>
  <button className="manager-status-btn" onClick={() => setActiveTab("closed")}>
        ...
        <div className="div-table">
          <table>
            ...
            {(activeTab === "open" ? openTickets : closedTickets).map((ticket, index) => (
              ...
              <td><span className="manager-status-text">{ticket.status}</span></td>
              <td className={`left-border color-${index % 5}`}>&nbsp;{ticket.priority}</td>
              <td>{ticket.agentAssigned}</td>
              <td className="manager-action-icons">
                <button className="manager-edit-btn"><i className="fa-solid fa-pen-to-square"></i></button>
                <button className="manager-delete-btn"><i className="fa-solid fa-trash"></i></button></td>
              </tr>
            ))}
            </tbody>
          </table>
