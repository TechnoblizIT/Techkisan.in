                ...
                <div className="in-out-details-page">
                  ...
                  <div className="table-container">
                    <div className="in-out-table-section">
                      <table className="in-out-details-table" ref={tableRef1}>
                        <thead>
                          <tr>
                            <th>Code</th>
                            <th>Name</th>
              ...
              {activeReportPage === "leave-details" && (
                <div className="leave-details-page">
                  ...
                  <div className="table-block">
                    <table className="leave-details-table" ref={tableRef2}>
                      <thead>
                        <tr>
                          <th>Status</th>
                          <th>From Date</th>
              ...
              {activeReportPage === "annual-attendance-summary" && (
                <div className="annual-attendance-summary">
                  ...
                  <div className="second-block">
                    <table className="attendance-table" ref={tableRef3}>
                      <thead>
                        <tr>
                          <th>Month</th>
              ...
              {activeReportPage === "holidays" && (
                <div className="holidays-page">
                  ...
                  <div className="holidays-table-section">
                    <table className="holidays-table" ref={tableRef4}>
                      <thead>
                        <tr>
                          <th>Date</th>
                          <th>Reason</th>
